...
class Search extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      keyword: this.props.value ? this.props.value : '',
      expanded: false,
      e: null,
    };
  ...
  // onTextInput = async e => {
  //   await this.setState({ keyword: e.nativeEvent.text, e: e });
  //   this.props.onTextInput &&
  //     (await this.props.onTextInput(this.state.e));
  // };
        ...
        <AnimatedTextInput
          ...
          style={[
            ...
            },
            {
              ...
              [isRtl ? 'paddingRight' : 'paddingLeft']: 32
            },
